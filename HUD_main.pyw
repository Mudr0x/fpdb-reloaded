...
class HUD_main(gobject.GObject):
...
#    This class mainly provides state for controlling the multiple HUDs.
    ...
    def client_moved(self, sender, hud):
...
gobject.signal_new("client_moved", HUD_main, gobject.SIGNAL_RUN_FIRST,
                   None, (str, int))
gobject.signal_new("client_resized", HUD_main, gobject.SIGNAL_RUN_FIRST,
                   None, (str, int))
gobject.signal_new("client_destroyed", HUD_main, gobject.SIGNAL_RUN_FIRST,
                   None, (str, int))
gobject.signal_new("game_changed", HUD_main, gobject.SIGNAL_RUN_FIRST,
                   None, (str, int))
gobject.signal_new("table_changed", HUD_main, gobject.SIGNAL_RUN_FIRST,
                   None, (str, int))
######################################################################
#   idle FUNCTIONS
#
