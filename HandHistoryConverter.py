...
HandHistoryConverter: '%(sitename)s'  
    ...
    def readSupportedGames(self, abstract=None): abstract

    # should return a list
    #   type  base limit
    # [ ring, hold, nl   , sb, bb ]
    # Valid types specified in docs/tabledesign.html in Gametypes
    def determineGameType(self, handText, abstract=None): abstract
...
or None if we fail to get the info """
    ...
    def readHandInfo(self, hand, abstract=None): abstract
    ...
    * hand.level
    ...
    def readPlayerStacks(self, hand, abstract=None): abstract
    ...
    *** NOTE: You may find this is a more appropriate place to set hand.maxseats ***
    ...
    def compilePlayerRegexs(self, abstract=None): abstract
    ...
    def markStreets(self, hand, abstract=None): abstract
    ...
    def readBlinds(self, hand, abstract=None): abstract
    ...
    def readAntes(self, hand, abstract=None): abstract
    """Function for reading the antes from the hand history and passing the hand.addAnte"""
    def readBringIn(self, hand, abstract=None): abstract
    def readButton(self, hand, abstract=None): abstract
    def readHoleCards(self, hand, abstract=None): abstract
    def readAction(self, hand, street, abstract=None): abstract
    def readCollectPot(self, hand, abstract=None): abstract
    def readShownCards(self, hand, abstract=None): abstract
        ...
        if hand.rake < 0 and (not hand.roundPenny or hand.rake < round) and not hand.cashedOut:
            ...
            ((hand.rake + Decimal(str(hand.sb)) - (0 if hand.rakes.get('rake') is None else hand.rakes['rake'])) == 0 or 
             (hand.rake + Decimal(str(hand.sb)) + Decimal(str(hand.bb)) - (0 if hand.rakes.get('rake') is None else hand.rakes['rake'])) == 0)
                ...
                log.error(_("hhc.getRake(): '%s': Missed sb/bb - Amount collected (%s) is greater than the pot (%s)") % (hand.handid,str(hand.totalcollected), str(hand.totalpot)))
            else:
    ...
    def readSummaryInfo(self, summaryInfoList, abstract=None): abstract
