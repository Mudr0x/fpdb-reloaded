...
class Database:
    ...
    def dumpDatabase(self):
        ...
        for table in (u'Actions', u'Autorates', u'Backings', u'Gametypes', u'Hands', u'Boards', u'HandsActions', u'HandsPlayers', u'HandsStove', u'Files', u'HudCache', u'Sessions', u'SessionsCache', u'TourneysCache',u'Players', u'RawHands', u'RawTourneys', u'Settings', u'Sites', u'TourneyTypes', u'Tourneys', u'TourneysPlayers'):
            print "table:", table
            result+="###################\nTable "+table+"\n###################\n"
            #rows=self.cursor.execute(self.sql.query['get'+table])  // bugged under Python 2.7
            rows=self.cursor.execute(u"SELECT * FROM " + table)
...
#        row = c.fetchone()
    ...
    def create_tables(self):
        ...
        c.execute(self.sql.query['addEffActiveStackIndex'])
        c.execute(self.sql.query['addEffMzoneIndex'])
        c.execute(self.sql.query['addEffActiveMzoneIndex'])
...
#    DON'T FORGET TO RECREATE THEM!!
    ...
    def fillDefaultData(self):
        ...
        c.execute("INSERT INTO Actions (id,name,code) VALUES ('17', 'walk', 'W')")
        #Fill Rank
...
# - existing static routines from fpdb_simple just modified
    ...
    def storeHand(self, hdata, doinsert = False, printdata = False):
        ...
        self.hbulk.append( [ hdata['tableName'],
                             ...
                             hdata['street0Callers'],
                             hdata['street1Callers'],
                             hdata['street2Callers'],
                             hdata['street3Callers'],
                             hdata['street4Callers'],

                             hdata['street0Aggressors'],
                             hdata['street1Aggressors'],
                             hdata['street2Aggressors'],
                             hdata['street3Aggressors'],
                             hdata['street4Aggressors'],
